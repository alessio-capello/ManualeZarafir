...
\newcommand{\Class}{Zarafir}
\newcommand{\BaseHP}{10}
\newcommand{\BaseLoad}{0}
\newcommand{\Damage}{4}
...
\renewcommand{\SectionTitle}{Caratteristiche fisiche}
\input{figuras/LeftBanner}

\begin{quote}
\begin{itemize}

\item \textbf{Sesso}:\enspace\hrulefill
\item \textbf{Età}:\enspace\hrulefill
\item \textbf{Peso}:\enspace\hrulefill
\item \textbf{Altezza}:\enspace\hrulefill
\item \textbf{Razza}:\enspace\hrulefill
\end{itemize}
...
\renewcommand{\SectionTitle}{Alignment}
...
\begin{quote}
Text that says what the move does. 
\end{quote}

\vfill\null
\columnbreak

\renewcommand{\SectionTitle}{Advanced Moves (Level 6+)}
\input{figuras/RightBanner}
